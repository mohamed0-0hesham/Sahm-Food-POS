...
import com.coditria.footpos.data.datastore.SettingsDataStoreFactory
...
val sharedModule = module {
    ...
    single { SettingsDataStoreFactory.create(get()) }

    single<ProductRepository> { ProductRepositoryImpl(get(), get()) }
    single<OrderRepository> { OrderRepositoryImpl(get(), get()) }
    single<SettingsRepository> { SettingsRepositoryImpl(get()) }
    // Cart depends on settings (live tax rate) and the app scope (for the settings observer).
